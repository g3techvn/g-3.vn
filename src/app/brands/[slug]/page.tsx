                ...
                <div key={product.id}>
                  <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col h-full overflow-hidden">
                    ...
                    <div className="flex-1 flex flex-col px-2 pt-2 pb-1">
                      {/* Badge giảm giá, Mall, Freeship... */}
                      <div className="flex flex-wrap gap-1 mb-1">
                        {typeof product.discount_percentage === 'number' && product.discount_percentage > 0 && (
                          <span className="bg-red-100 text-red-600 text-xs font-bold px-2 py-0.5 rounded">-{product.discount_percentage}%</span>
                        )}
                      ...
                      <div className="font-medium text-sm text-gray-900 line-clamp-2 mb-1">{product.name}</div>
                      <div className="flex items-end gap-2 mb-1">
                        ...
                        <button 
                          className="ml-auto p-1.5 bg-red-600 text-white rounded-full shadow hover:bg-red-700 transition-colors duration-200"
